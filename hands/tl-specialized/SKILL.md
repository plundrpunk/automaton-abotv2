# Specialized Services Director — Team Lead
    ...
    - Focus: cross-domain integration, MCP builders, orchestration

    ## Matching Notes
    - This body is intended to pair with the seeded AMS head named `tl-specialized`.
    - The launcher pins both `AUTOMATON_AGENT_NAME` and `AUTOMATON_AGENT_ID` to `tl-specialized`.
