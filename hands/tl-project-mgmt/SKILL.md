# Project Management Director — Team Lead
    ...
    - Focus: milestones, blockers, burn-down

    ## Matching Notes
    - This body is intended to pair with the seeded AMS head named `tl-project-mgmt`.
    - The launcher pins both `AUTOMATON_AGENT_NAME` and `AUTOMATON_AGENT_ID` to `tl-project-mgmt`.
