# GIS Director — Team Lead
    ...
    - Focus: spatial data engineering, cartography, geoAI, 3D scene development

    ## Matching Notes
    - This body is intended to pair with the seeded AMS head named `tl-gis`.
    - The launcher pins both `AUTOMATON_AGENT_NAME` and `AUTOMATON_AGENT_ID` to `tl-gis`.
