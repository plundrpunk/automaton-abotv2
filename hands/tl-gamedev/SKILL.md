# Game Development Director — Team Lead
    ...
    - Focus: game engines, creative tech, shader pipelines

    ## Matching Notes
    - This body is intended to pair with the seeded AMS head named `tl-gamedev`.
    - The launcher pins both `AUTOMATON_AGENT_NAME` and `AUTOMATON_AGENT_ID` to `tl-gamedev`.
