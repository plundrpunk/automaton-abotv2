# Academic Research Director — Team Lead
    ...
    - Focus: frameworks, evidence, methodology

    ## Matching Notes
    - This body is intended to pair with the seeded AMS head named `tl-academic`.
    - The launcher pins both `AUTOMATON_AGENT_NAME` and `AUTOMATON_AGENT_ID` to `tl-academic`.
