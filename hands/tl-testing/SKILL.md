# Testing & QA Director — Team Lead
    ...
    - Focus: test coverage, edge cases, automation

    ## Matching Notes
    - This body is intended to pair with the seeded AMS head named `tl-testing`.
    - The launcher pins both `AUTOMATON_AGENT_NAME` and `AUTOMATON_AGENT_ID` to `tl-testing`.
