# Support Director — Team Lead
    ...
    - Focus: operations, compliance, analytics

    ## Matching Notes
    - This body is intended to pair with the seeded AMS head named `tl-support`.
    - The launcher pins both `AUTOMATON_AGENT_NAME` and `AUTOMATON_AGENT_ID` to `tl-support`.
